# BadAppleBot - Loev06
This repo contains one of my submissions for the Chess Coding Challenge by Sebastian Lague. This submission isn't a chess engine though. Using the function `BitboardHelper.VisualizeBitboard(ulong bitboard)` I made a video player. [The encoder for the video](https://github.com/Loev06/BadAppleBot/blob/main/Bad%20Apple%20Encoder/BadAppleEncoder.py) was originally made for just myself, but I cleaned it up a bit for others to use. The video player itself can be found [Here](https://github.com/Loev06/BadAppleBot/blob/main/Chess-Challenge/src/My%20Bot/MyBot.cs).
